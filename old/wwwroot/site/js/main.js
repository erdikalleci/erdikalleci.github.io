...
// Back to top button
window.ScrollTop = $(window).scroll(function () {
...
window.ScrollTopAnimate = $('.back-to-top').click(function () {
    $('html, body').animate({ scrollTop: 0 }, 1500, 'easeInOutExpo');
    return false;
});

// Initiate the wowjs animation library
window.SuperfishInit = new WOW().init();

// Initiate superfish on nav menu
window.SuperfishNavMenu = $('.nav-menu').superfish({
    animation: {
        opacity: 'show'
    },
    speed: 400
